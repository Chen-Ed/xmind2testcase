...
class FileUploadHandler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        if content_type == 'application/json':
            ...
            file_path = os.path.join(os.path.abspath(r"C:/Users/te_chenyingdong/Desktop"), datetime.now().strftime("%Y%m%d_%H%M%S") +"_"+ file_name)
        ...
        #   file_path = os.path.join(os.getcwd(), file_name)
          file_path = os.path.join(os.path.abspath(r"C:/Users/te_chenyingdong/Desktop"), file_name)
